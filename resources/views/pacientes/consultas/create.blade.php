                ...
                <div class="dt--top-section">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="datetime-local" id="data_e_hora" name="data_e_hora" class="form-control" required>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="sintomas" name="sintomas" class="form-control" placeholder="Descreva os sintomas (opcional)"></textarea>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="diagnostico" name="diagnostico" class="form-control" placeholder="Descreva o diagnóstico (opcional)"></textarea>
                            </div>

                            <div class="col-md-6">
                                <label for="prescricao_medica">Prescrição Médica</label>
                                <textarea id="prescricao_medica" name="prescricao_medica" class="form-control" placeholder="Prescrição médica (opcional)"></textarea>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <textarea id="exames_solicitados" name="exames_solicitados" class="form-control" placeholder="Exames solicitados (opcional)"></textarea>
                            </div>

                            <div class="col-md-6">
                                <label for="observacoes_medicas">Observações Médicas</label>
                                <textarea id="observacoes_medicas" name="observacoes_medicas" class="form-control" placeholder="Observações médicas (opcional)"></textarea>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <textarea id="historico_doenca_atual" name="historico_doenca_atual" class="form-control" placeholder="Histórico da doença atual (opcional)"></textarea>
                            </div>

                            <div class="col-md-6">
                                <label for="historico_familiar">Histórico Familiar</label>
                                <textarea id="historico_familiar" name="historico_familiar" class="form-control" placeholder="Histórico familiar (opcional)"></textarea>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea id="historico_medico" name="historico_medico" class="form-control" placeholder="Histórico médico (opcional)"></textarea>
