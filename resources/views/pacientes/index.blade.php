                ...
                <div class="row items-center">
                    <div class="col-12 col-sm-6 d-flex justify-content-sm-start justify-content-center">
                        <div class="dataTables_length" id="style-3_length">
                            ...
                            <a href="{{ route('paciente.create') }}" class="btn btn-success btn-lg">
            ...
            <div class="table-responsive">
                <table id="style-3" class="table style-3 table-hover dataTable no-footer" role="grid"
                    ...
                    @forelse($pacientes as $paciente)
                        <tr role="row">
                            <td class="checkbox-column text-center sorting_1">{{ $paciente->matricula }}</td>
                            ...
                            <td class="text-center">
                                   <span class="shadow-none badge badge-{{ $paciente->ativo ? 'success' : 'danger' }}">
                                       {{ $paciente->ativo ? 'ATIVO' : 'NÃO ATIVO' }}
                                   </span>
                            </td>
                            <td class="text-center">
                                <ul class="table-controls">
                                    <li>
                                        <a href="{{ route('paciente.edit', $paciente->id) }}" class="bs-tooltip" data-toggle="tooltip"
