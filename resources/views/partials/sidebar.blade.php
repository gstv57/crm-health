        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                <li class="menu {{ Request::is('dashboard*') ? 'active' : '' }}">
                    <a href="#dashboard" data-active="{{ Request::is('dashboard*') ? 'true' : 'false' }}" data-toggle="collapse" aria-expanded="{{ Request::is('dashboard*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled {{ Request::is('dashboard*') ? 'show' : '' }}" id="dashboard" data-parent="#accordionExample">
                ...
                <li class="menu {{ Request::is('usuarios*') ? 'active' : '' }}">
                    <a href="#app" data-toggle="collapse" aria-expanded="{{ Request::is('usuarios*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled {{ Request::is('usuarios*') ? 'show' : '' }}" id="app" data-parent="#accordionExample">
                ...
                <li class="menu {{ Request::is('pacientes*') ? 'active' : '' }}">
                    <a href="#components" data-toggle="collapse" aria-expanded="{{ Request::is('pacientes*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled {{ Request::is('pacientes*') ? 'show' : '' }}" id="components" data-parent="#accordionExample">
                ...
                <li class="menu {{ Request::is('medicos*') ? 'active' : '' }}">
                    <a href="#medicos" data-toggle="collapse" aria-expanded="{{ Request::is('medicos*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled {{ Request::is('medicos*') ? 'show' : '' }}" id="medicos" data-parent="#accordionExample">
                ...
                <li class="menu {{ Request::is('roles*') ? 'active' : '' }}">
                    <a href="#elements" data-toggle="collapse" aria-expanded="{{ Request::is('roles*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                    ...
                    <ul class="collapse submenu list-unstyled {{ Request::is('roles*') ? 'show' : '' }}" id="elements" data-parent="#accordionExample">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled menu-categories" id="accordionExample">
                ...
                <li class="menu {{ Request::is('medicos/consulta*') ? 'active' : '' }}">
                    <a href="#consultas-menu" data-toggle="collapse" aria-expanded="{{ Request::is('medicos/consulta*') ? 'true' : 'false' }}" class="dropdown-toggle">
                        <div class="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                 fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <ul class="collapse submenu list-unstyled {{ Request::is('medicos/consulta*') ? 'show' : '' }}" id="consultas-menu" data-parent="#accordionExample">
